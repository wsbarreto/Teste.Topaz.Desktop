...
using Teste.Topaz.Desktop.ControlSkin.Controls;
using Teste.Topaz.Desktop.Properties;
...
public class MaterialSkinManager
{
    ...
    private void UpdateToolStrip(ToolStrip toolStrip, Color newBackColor)
    {
        ...
        foreach (ToolStripItem control in toolStrip.Items)
        {
            ...
            if (control is MaterialSkin.Controls.MaterialToolStripMenuItem && (control as MaterialSkin.Controls.MaterialToolStripMenuItem).HasDropDown)
            {

                //recursive call
                UpdateToolStrip((control as MaterialSkin.Controls.MaterialToolStripMenuItem).DropDown, newBackColor);
            }
        }
    }
